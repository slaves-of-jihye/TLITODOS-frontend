...
export const theme = {
  colors: {
    ink: "#1d1d1d", muted: "#647f8b", line: "#e8edf2", panel: "#f7f9fb", white: "#ffffff",
    selected: "#202020", blue: "#145dff", red: "#ff4562", overlay: "rgba(29,29,29,.44)", loginOverlay: "rgba(29,29,29,.66)",
  },
